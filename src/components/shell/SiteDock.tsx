...
function IconCart({ active, filled }: { active: boolean; filled: boolean }) {
  ...
  return (
    <svg className={stroke} width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden>
      {/* Kapalı torba — stroke ile hizalı yaklaşık dolgu */}
      <path
        className={fill}
...
/** Alt sabit menü: ana sayfa + favoriler + sepet + profil. */
export function SiteDock() {
  ...
  return (
    <nav
      className="fixed bottom-0 left-0 right-0 z-40 border-t border-zinc-200 bg-white/95 pb-[env(safe-area-inset-bottom,0px)] backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/95"
    ...
    >
      <div className="mx-auto grid max-w-lg grid-cols-4 gap-0.5 px-1 py-2">
        <Link
          href="/"
          className={[
            "flex min-w-0 flex-col items-center gap-0.5 rounded-xl px-1 py-1.5 text-[10px] font-medium sm:text-[11px]",
            home ? "text-emerald-800 dark:text-emerald-200" : "text-zinc-600 dark:text-zinc-400",
          ].join(" ")}
        >
        ...
        <Link
          ...
          className={[
            "flex min-w-0 flex-col items-center gap-0.5 rounded-xl px-1 py-1.5 text-[10px] font-medium sm:text-[11px]",
            favoriler ? "text-emerald-800 dark:text-emerald-200" : "text-zinc-600 dark:text-zinc-400",
          ].join(" ")}
        >
        ...
        <Link
          ...
          className={[
            "flex min-w-0 flex-col items-center gap-0.5 rounded-xl px-1 py-1.5 text-[10px] font-medium sm:text-[11px]",
            sepet ? "text-emerald-800 dark:text-emerald-200" : "text-zinc-600 dark:text-zinc-400",
          ].join(" ")}
        >
        ...
        <Link
          ...
          className={[
            "flex min-w-0 flex-col items-center gap-0.5 rounded-xl px-1 py-1.5 text-[10px] font-medium sm:text-[11px]",
            profil ? "text-emerald-800 dark:text-emerald-200" : "text-zinc-600 dark:text-zinc-400",
          ].join(" ")}
        >
